...
CREATE TABLE `course` (
  `id` int NOT NULL AUTO_INCREMENT,
  `course_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'course_name',
...
CREATE TABLE `enrollment` (
  ...
  `academic_year` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'academic_year',
...
INSERT INTO `enrollment` VALUES (2,0,'Autumn semester',1,2,1),(3,0,'Autumn semester',1,1,2),(4,0,'Autumn semester',1,8,1);
...
CREATE TABLE `instructor` (
  ...
  `phone` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'phone',
  `email` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'email',
  `department` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'department',
  PRIMARY KEY (`id`)
...
CREATE TABLE `student` (
  ...
  `phone` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'phone',
  `email` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'email',
  `major` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'major',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `student` VALUES (1,'stu1','1079e43547c7a3f894a721ed8cd1c2a2',NULL,NULL,'jurisprudence'),(2,'stu2','a0ccd45711ced41fb131a1fc063ef51b','19978066054','123@outlook.com','software engineering'),(4,'stu3','a6366adf2eef448dd906a30ea24135a7','19978066054','123@outlook.com','');
...
-- Dump completed on 2024-05-28 22:20:42
